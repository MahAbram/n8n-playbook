...
meta-og:description: An open-source playbook for shipping real workflows with n8n — for operators, analysts, marketers, founders, engineers.
meta-og:type: website
meta-twitter:card: summary_large_image
meta-twitter:title: Learn Automation Working
meta-twitter:description: An open-source playbook for shipping real workflows with n8n.
---
